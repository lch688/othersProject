...
var Crowlar = /** @class */ (function () {
    function Crowlar(url, analyser) {
        this.url = url;
        this.analyser = analyser;
        this.filepath = path_1.default.resolve(__dirname, '../../data/save.json');
        this.initProcess();
    }
    Crowlar.prototype.initProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        jsonData = this.analyser.analyse(html, this.filepath);
    ...
    Crowlar.prototype.getHtml = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Crowlar.prototype.saveJsondata = function (content) {
